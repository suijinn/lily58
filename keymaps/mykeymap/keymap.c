...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_RBRC,  KC_NUHS,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_INT1,
                     KC_LALT,  MO(1), KC_LSFT,  KC_SPC,  KC_ENT,   KC_LCTL,  MO(2),   KC_RGUI
),
...
[_RAISE] = LAYOUT(
  ...
  KC_TRNS, KC_HOME, KC_TRNS, KC_DEL,  KC_TRNS, KC_TRNS,                     KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_SCRL, KC_TRNS,
  KC_LSFT, KC_LGUI, KC_LALT, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_PGDN, KC_TRNS, KC_TRNS,
                             KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
