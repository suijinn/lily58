 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LGUI  | Alt  |Lo,Eng| /Space  /       \Enter \  |Sft,Jp|Raise |Adjst |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `-------------------''-------'           '------''--------------------'
 */
 ...
 * |      |      |      |  END |      |      |                    |      |      |  UP  |      | PrSc  | F12 |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | CAPS | HOME |      |  DEL |      |      |-------.    ,-------|      | Left | Down |Right | Scrl |      |
 * |------+------+------+------+------+------|  ^    |    |    \  |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      |      | PgUp | PgDn | App  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      |      |      |
...
[_RAISE] = LAYOUT(
  ...
  KC_TRNS, KC_HOME, KC_TRNS, KC_DEL,  KC_TRNS, KC_TRNS,                     KC_BSPC, KC_LEFT, KC_DOWN, KC_RIGHT, KC_SCRL, KC_PAUSE,
...
[_ADJUST] = LAYOUT(
  KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_U, XXXXXXX, XXXXXXX,                   KC_BTN5, KC_BTN1, KC_MS_U, KC_BTN2, XXXXXXX, KC_F12,
