...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_RBRC,  KC_NUHS,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_INT1,
                    KC_LGUI, KC_LALT, LT(_LOWER, KC_LNG2), KC_SPC,  KC_ENT,   SFT_T(KC_LNG),  MO(_RAISE),   LT(_ADJUST, KC_GRV)
),
...
[_LOWER] = LAYOUT(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_TRNS, KC_TRNS, KC_TRNS, KC_EQL, KC_INT3,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(3),
...
[_RAISE] = LAYOUT(
  ...
  KC_LSFT, KC_LGUI, KC_LALT, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_PGDN,  KC_APP,  KC_TRNS,
                             KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
 ...
 */
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_U, XXXXXXX, XXXXXXX,                   KC_BTN5, KC_BTN1, KC_MS_U, XXXXXXX, XXXXXXX, XXXXXXX,
